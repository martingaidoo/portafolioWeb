...
import downcount from '../images/countdown.png'

import typescript from '../images/typescript-svgrepo-com.png'
    ...
    <section className="padding" id="portfolio">
      ...
      <div style={{ display: "flex", flexDirection: "row", paddingTop: "3rem" }}>
        <div className="container">
            ...
            <div className="box">
              <img src={downcount} alt="1" style={{height:"10rem", paddingTop: "2rem"}}/>
              <div className="Informacion">
                <h3 style={{ flexBasis: "40px" }}>Count Down</h3>
              <p className="small">Es una página simple desarrollada para la inauguración de un boliche. Utiliza React con TypeScript y también hace uso de algunos elementos de Bootstrap para hacerla responsive. Además, se incorporaron algunas incrustaciones de código proporcionadas por Spotify y Google Maps.</p>
              <div className="tecnologias">
            <ComponentHabilidadChico title="HTML" imagen={html} />
            <ComponentHabilidadChico title="CSS" imagen={css} />
            <ComponentHabilidadChico title="TypeScript" imagen={typescript} />
            <ComponentHabilidadChico title="React" imagen={react} />
            <ComponentHabilidadChico title="Boostrap" imagen={boostrap} />
              ...
              <div className="redes margen1rem">
              <a href="https://github.com/martingaidoo/CountDownPuebla"
                          target="_blank"
                          rel="noopener noreferrer">
              <button className="btn margen1rem">
              <svg width="40" height="40" fill="#0092E4" xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" viewBox="0 0 24 24" id="github">
            ...
            <a href="https://thankful-smoke-009e88c10.5.azurestaticapps.net/"
                        target="_blank"
                        rel="noopener noreferrer">
            <button className="btn margen1rem">
            <img src="data:image/png;base64," alt="link"/>
